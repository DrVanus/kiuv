...
var body: some View {
    VStack(spacing: 0) {
        ...
        chartSection
            ...
            // Fill the available width and increase height for better visibility
            .frame(maxWidth: .infinity, minHeight: 0, idealHeight: 250, maxHeight: 250)
...
private var navBar: some View {
    ...
    private var chartSection: some View {
        CryptoChartView(symbol: symbol, interval: selectedInterval, height: 200)
    }
