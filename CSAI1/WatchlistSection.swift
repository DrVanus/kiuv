        ...
        HStack(spacing: 8) {
            ...
            HStack(spacing: 12) {
                ...
                HStack(spacing: 2) {
                    ...
                    HStack(spacing: 2) {
                        Image(systemName: coin.hourlyChange >= 0 ? "arrowtriangle.up.fill" : "arrowtriangle.down.fill")
                            .foregroundColor(coin.hourlyChange >= 0 ? .green : .red)
                            .imageScale(.small)
                        Text(String(format: "%.2f%%", coin.hourlyChange))
                            .foregroundColor(.white)
                            .font(.caption2)
                    }
                }
                ...
                HStack(spacing: 2) {
                    Text("24H:")
                        .foregroundColor(.white.opacity(0.7))
                    HStack(spacing: 2) {
                        Image(systemName: coin.dailyChange >= 0 ? "arrowtriangle.up.fill" : "arrowtriangle.down.fill")
