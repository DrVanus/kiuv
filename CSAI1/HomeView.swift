...
//  CRYPTOSAI
//
//  ~1000 lines, with 7 timeframes (24H, 1W, 1M, 3M, 6M, 1Y, ALL) and a more polished AI Analysis sheet.
//
//  Make sure your HomeViewModel only has watchlist/trending as [String],
//  plus numeric portfolioValue/dailyChange. No conflicting "CoinItem" struct.
...
// MARK: - Local CoinItem for Gainers/Losers
...
struct HomeView: View {
    ...
    // In real usage, you'd fetch from your API based on the selected timeframe
...
extension HomeView {
    ...
    private var portfolioContainer: some View {
        VStack(spacing: 16) {
            ...
            // Horizontal chip row for extended timeframes
            timeframeChipRow
            
            portfolioSummary
            sparklineView
            
            // AI short insight + button
            aiInsightSection
        }
        .padding(16)
        .background(Color.white.opacity(0.05))
    ...
    // The row of 7 timeframes: 24H, 1W, 1M, 3M, 6M, 1Y, ALL
    ...
    // The more polished AI analysis sheet
    private var aiAnalysisSheet: some View {
        ZStack {
            Color.black.ignoresSafeArea()
            
            VStack {
                // A small "grab bar" or handle at the top
